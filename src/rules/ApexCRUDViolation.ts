...
@suggestion(
    'SOQL/DML statements that do not specify "USER_MODE" are not secure by default, so unless there is some reasonable justification consider using WITH USER_MODE in your statements.'
)
@ruleSeverity(3)
