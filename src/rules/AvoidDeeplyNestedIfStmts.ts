...
@suggestion(
    'If statements that have too much "depth" can be confusing to follow for a maintainer. In most cases, these statements can be consolidated or refactored to have a flatter layout.'
)
@ruleSeverity(3)
