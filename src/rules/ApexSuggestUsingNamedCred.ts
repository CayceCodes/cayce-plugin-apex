...
@suggestion(
    'Due to the sensitive nature of (x)Auth access to external systems (and the potentially sensitive data that they provide) use of named/external credentials for access is a must.'
)
@ruleSeverity(3)
