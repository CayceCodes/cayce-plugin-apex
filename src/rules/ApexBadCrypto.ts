...
@suggestion(
    'In order to ensure that an encrypted value is secure, it is considered essential to use values unknown and hard to predict for both the key and initialization vector (IV). Consider generating using the built-in functions or another, equally secure random initialization method.'
)
@ruleSeverity(3)
@treeQuery(
